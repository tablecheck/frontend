...
function getIndentSpaces(depth: number, postfix = '└ ', separator = '|') {
...
export function logTaskStart(message: string) {
...
export function logTaskEnd(isSuccessOrWarnings?: boolean | string[]) {
  const depth =
