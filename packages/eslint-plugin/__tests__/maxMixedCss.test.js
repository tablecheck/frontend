...
const rule = require('../src/maxMixedCss');
...
ruleTester.run('maxMixedCss > with JSX', rule, {
...
ruleTester.run('maxMixedCss > without JSX', rule, {
  valid: []
    .concat(
      singleTestCases,
      interpolationTestCases,
      [
        `
    import { md } from 'markdown';
    const text = md\`
    ...
    `
      ...
      nestedTestCases,
      doubleNestedTestCases,
      singleTestCases,
      interpolationTestCases,
      nestedTestCases,
      doubleTestCases,
      doubleInterpolationTestCases,
      doubleNestedTestCases
    )
    .map((code) => ({
      code,
