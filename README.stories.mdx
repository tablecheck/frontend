...
It is largely inspired (and copied) from Facebook's [`create-react-app`](https://github.com/facebook/create-react-app) system but doesn't support the "eject" functionality.
This way we can keep the same scripts across all our projects without having to copy paste settings and scripts from one to the other.
