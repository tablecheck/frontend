# v1.7.0 (Mon Oct 11 2021)

#### 🚀 Enhancement

- feat: support exporting a bundle as a lib from an app [#30](https://github.com/tablecheck/tablecheck-react-system/pull/30) ([@SimeonC](https://github.com/SimeonC))
